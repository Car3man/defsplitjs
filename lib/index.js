...
function split(pathToGraph, pathToArchive, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const archive of splitDeclaration) {
            ...
            const zipPath = (0, path_2.join)(outputPath, `${archive.name}.zip`);
...
const pathToGraph = (0, path_2.join)(__dirname, "../example/game.graph.json");
const pathToArchive = (0, path_2.join)(__dirname, "../example/resourcepack.zip");
split(pathToGraph, pathToArchive, SplitOptions.byCollections());
